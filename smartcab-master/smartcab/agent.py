...
class LearningAgent(Agent):
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
        	...
        	max_act_list = [] # newly added code
        	for act in self.Q[state]:
        		if self.Q[state][act] == max_Q:
        			# old code, comment it out
        			# action = act 
        			# newly added code, put all max_Q actions in to a list
        			max_act_list.append(act) 
        	# newly added code, randomly select an action with max_Q
        	action = random.choice(max_act_list) 
    ...
    def learn(self, state, action, reward):
        ...
        # Original answer which is not correct
        # self.Q[state][action] += reward * self.alpha

        # Corrected answer according to the reviewer's advice.
